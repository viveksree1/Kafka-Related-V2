...
export KAFKA_JMX_OPTS="-javaagent:/opt/ns/kafka/libs/jolokia-agent.jar=port=8778,host=localhost -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.rmi.port=$JMX_PORT"
